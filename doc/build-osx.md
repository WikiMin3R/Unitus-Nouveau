...
Unitus is now available at `./src/unitusd`
...
The first time you run unitusd, it will start downloading the blockchain. This process could take several hours.

You can monitor the download process by looking at the debug.log file:

    tail -f $HOME/Library/Application\ Support/Unitus/debug.log
...
4. Enter "unitus-qt" as project name, enter src/qt as location
