 ...
 * between unitusd, and unitus-qt and non-server tools.
*/
...
std::string LicenseInfo()
{
    ...
    const std::string URL_WEBSITE = "<https://unituscurrency.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i-%i The Unitus Developers", 2024, COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Unitus useful. "
