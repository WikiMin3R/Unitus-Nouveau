...
const char* BIP71_MIMETYPE_PAYMENT = "application/unitus-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/unitus-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/unitus-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click unitus: links
...
//
// OSX-specific way of handling unitus: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in unitus: URIs
